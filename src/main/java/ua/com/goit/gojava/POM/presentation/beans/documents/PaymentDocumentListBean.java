...
@ViewScoped
@ManagedBean
public class PaymentDocumentListBean extends DataObjectListViewer<PaymentDocument> {

	private static final long serialVersionUID = 1L;
	private static final String CLASS_NAME = "Payment Document"; 
	private static final Logger LOG=Logger.getLogger(PaymentDocumentListBean.class);
